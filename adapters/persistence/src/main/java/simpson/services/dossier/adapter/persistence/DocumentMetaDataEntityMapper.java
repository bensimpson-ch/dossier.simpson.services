...
enum DocumentMetaDataEntityMapper {
    ...
    MetaData map(DocumentMetaDataEntity documentMetaDataEntity) {
        ...
        return new MetaData(new Name(documentMetaDataEntity.getName()), new Description(documentMetaDataEntity.getDescription()), new Size(documentMetaDataEntity.getSize()), new Modified(modified));
    }
}
